...
import { Platform, View, ImageBackground, StyleSheet, Alert, CameraRoll, Dimensions } from 'react-native';
                ...
                <Camera style={{ flex: 1 }}
                    ...
                    <View style={styles.bottomBar}>
                        <View style={styles.cameraButton}>
                            <Button large warning rounded onPress={() => this.props.navigation.pop()}>
                                <Text>O</Text>
                            </Button>
                        </View>
                    </View>
