...
const sources = [   {img: require('../assets/thor.png'), tags: ["marvel", "superhero"]},
                    {img: require('../assets/deadpool.png'), tags: ["marvel", "superhero"]},
                    {img: require('../assets/doctorstrange.png'), tags: ["marvel", "superhero"]},
                    {img: require('../assets/antman.png'), tags: ["marvel", "superhero"]},
                    {img: require('../assets/captainamerica.png'), tags: ["marvel", "superhero"]},
